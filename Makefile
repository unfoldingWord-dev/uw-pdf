...
runDevDebug: checkEnvVariables
	...
	docker run --env AWS_ACCESS_KEY_ID --env AWS_SECRET_ACCESS_KEY --env REDIS_URL --env QUEUE_PREFIX="dev-" --env DEBUG_MODE=On --name uw-pdf --rm --publish 8124:80 --interactive --tty --cpus=0.5 unfoldingword/obs-pdf:develop bash
